...
<div class="row">
    <div class="col-lg-12">
        <section class="panel">
            ...
            {!! Form::model($categories, ['route' => ['categories.update', $categories->id], 'method'=>'patch', 'class'=>'cmxform form-horizontal tasi-form', 'id'=>'categories']) !!}
            ...
            <a href="{{ URL::route('kuisioners', ['data'=>Session::get('ss_responden_id')]) }}" class="btn btn-default" type="button">Batal</a>
            </div>
        	  {!! Form::close() !!}
        	</div>
        </section>
